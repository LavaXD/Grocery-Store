...
<body>
    <div class="container">
        ...
        <div class="listProduct">
            ...
            <?php
            $id = $_GET["category_id"];
            $sqlProducts = "select * from Products where category_id ={$id}";
            $resProducts = $conn->query($sqlProducts);
            if ($resProducts->num_rows > 0) {
                while ($rowProducts = $resProducts->fetch_assoc()) {
                    $id = $rowProducts["product_id"];
                    ?>
                    <div class="item">
                        <img src="images/<?php echo $rowProducts["product_id"]; ?>.jpg">
                        ...
                        <?php
                        $stock = $rowProducts['stock_quantity'];
                        if ($stock <= 0) {
