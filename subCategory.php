...
<body>
    <div class="container">
        ...
        <div class="listProduct">
            ...
            $sqlProduct = "select * from Products where sub_category_id ={$sub_category_id}";
            $resProduct = $conn->query($sqlProduct);
            if ($resProduct->num_rows > 0) {
                while ($rowProduct = $resProduct->fetch_assoc()) {
                    $id = $rowProduct["product_id"];
                    ?>
                    <div class="item">
                        <img src="images/<?php echo $rowProduct["product_id"]; ?>.jpg">
                        ...
                        <?php
                        $stock = $rowProduct['stock_quantity'];
                        if ($stock <= 0) {
